define([
    ...
    'brease/enum/Enum', 
    'brease/core/Utils'
], function (SuperClass, BreaseEvent, d3, Types, Enum, Utils) {
    ...
    p.drawElements = function () {
        ...
        this.sliderRectangle = this.createSliderRectangle(this.sliderElement, parseInt(this.settings.height, 10), parseInt(this.settings.width, 10), parseInt(this.settings.trackSize, 10), this.settings.orientation);
        this.createDragBehavior();
        this.sliderThumb = this.createSliderThumb(this.sliderElement, parseInt(this.settings.height, 10), parseInt(this.settings.width, 10), parseInt(this.settings.thumbSize, 10), this.dragBehavior, this.settings.orientation);
        this.thumbBackground = this.createThumbBackGround(this.settings.orientation, this.settings.thumbSize, parseInt(this.settings.height, 10), parseInt(this.settings.width, 10), this.thumbScale(this.widget.data.node.value));
        this.rectangleBackground = this.createRectangleBackground(this.settings.orientation, parseInt(this.settings.height, 10), parseInt(this.settings.width, 10), parseInt(this.settings.trackSize, 10));
    ...
    p.drawFillElement = function () {
        ...
        switch (this.settings.orientation) {
            case Enum.Orientation.LTR:
                ...
                this.fillElement.css('top', (parseFloat(this.settings.height, 10) / 2) - (this.settings.trackSize / 2));
            ...
            case Enum.Orientation.BTT:
                ...
                this.fillElement.css('top', parseFloat(this.settings.height, 10) - this.settings.thumbRadius);
                this.fillElement.css('left', (parseFloat(this.settings.width, 10) / 2) - this.settings.trackSize / 2);
    ...
    p.valueDisplayDraw = function () {
        ...
        if (this.settings.orientation === Enum.Orientation.LTR || this.settings.orientation === Enum.Orientation.RTL) {
            ...
            this.output.css('height', this.settings.valueDisplaySize)
                .css('top', this.settings.height / 2 - this.settings.valueDisplaySize - this.settings.thumbRadius - outputPadding)
                .css('width', width);
        } else if (this.settings.orientation === Enum.Orientation.TTB || this.settings.orientation === Enum.Orientation.BTT) {
            this.output.addClass('vertical');
            this.output.removeClass('horizontal');
            this.output.css('width', width)
                .css('right', this.settings.width / 2 + this.settings.thumbRadius + outputPadding)
    ...
    p.updateThumb = function () {
        ...
        if (this.settings.orientation === Enum.Orientation.LTR || this.settings.orientation === Enum.Orientation.RTL) {
            ...
            this.output.css('left', this.settings.thumbPosition);
        } else if (this.settings.orientation === Enum.Orientation.TTB || this.settings.orientation === Enum.Orientation.BTT) {
            ...
            this.output.css('top', this.settings.thumbPosition);
        }
    };
